...
# language detection in Whisper by Jotanner on HuggingFace
def detect_language_epicly(model: WhisperForConditionalGeneration, tokenizer: WhisperTokenizer, input_features,
